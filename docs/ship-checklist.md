...
| Performance benchmark | PASS | 120 conversations / 12,000 messages: launch 0.1463s, transcript page 0.0002s, exact search 0.0035s, semantic search 0.3525s, transcript route 0.0001s. |
| Unsigned release dry run | PASS | `./scripts/release/local-dry-run.sh` produced `build/Release/i2Message-0.1.0-unsigned.dmg`. |
| Unsigned DMG checksum | PASS | SHA-256 `c513ac83aeabd6d325799695a30104fa4736dbb8878898821b0e9b2f0d1adf8e`. |
